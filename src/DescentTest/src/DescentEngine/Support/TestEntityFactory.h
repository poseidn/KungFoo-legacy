...
public:
	...
	template<class TEntityType>
	TEntityType * createNonVisual(Vector2 initialPosition, Rectangle2 boundingBox, LayerPriority prio =
...
// todo: refactor these two methods
	...
	TEntityType * create(std::string const& templateName, Vector2 initialPosition, LayerPriority prio =
			LayerPriorityBottom) {
