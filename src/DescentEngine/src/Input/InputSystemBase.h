...
public:
	...
	constexpr static size_t MaxPlayerInput = 2;

	typedef int PlayerInputId;
	typedef int ContainerId;
	constexpr static ContainerId InvalidContainerId = -1000;
	...
	void assignPlayerToInput(PlayerInputId pl, ContainerId containerId) {
		...
		logging::Info() << "Assiging player " << pl << " to containerId" << containerId << std::endl;
	}
